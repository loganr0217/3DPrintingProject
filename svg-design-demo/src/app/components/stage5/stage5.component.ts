...
export class Stage5Component implements OnInit {
  ...
  getPanelWidth(top:boolean = true):string {
    ...
    //return top ? this.convertBackNumber(this.sharedDataService.topPanelWidth, this.sharedDataService.unitChoice).toFixed(2) : this.convertBackNumber(this.sharedDataService.bottomPanelWidth, this.sharedDataService.unitChoice).toFixed(2);
  ...
  getPanelHeight(top:boolean = true):string {
    ...
    //return top ? this.convertBackNumber(this.sharedDataService.topPanelHeight, this.sharedDataService.unitChoice).toFixed(2) : this.convertBackNumber(this.sharedDataService.bottomPanelHeight, this.sharedDataService.unitChoice).toFixed(2);
